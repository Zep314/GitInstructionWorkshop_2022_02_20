...
### Порядок действий для работы с удаленным репозитарием
1. Делаем fork интересующего нас репозитория на GitHub
1. Делаем git clone для нашей версии этого репозитория
1. Мы создаем ветку с предлагаемыми изменениями
1. Производим все изменения в этой ветке
1. Отправляем эти изменения в свой аккаунт на gitHub (git push)
1. В окне на gitHub появляется возможность сделать pull request
